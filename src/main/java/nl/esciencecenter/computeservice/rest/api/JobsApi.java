...
public interface JobsApi {
	...
	default ResponseEntity<Job> cancelJobById(
	...
	default ResponseEntity<Void> deleteJobById(
			@ApiParam(value = "Job ID", required = true) @PathVariable("jobId") String jobId) {
		// do some magic!
	...
	default ResponseEntity<Job> getJobById(
			@ApiParam(value = "Job ID", required = true) @PathVariable("jobId") String jobId) {
		// do some magic!
		return new ResponseEntity<Job>(HttpStatus.OK);
	}
	...
	default ResponseEntity<Object> getJobLogById(
			@ApiParam(value = "Job ID", required = true) @PathVariable("jobId") String jobId) {
		// do some magic!
	...
	default ResponseEntity<Job> postJob(
