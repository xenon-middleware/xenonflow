...
import nl.esciencecenter.computeservice.rest.Swagger2SpringBoot;
...
public interface JobsApi {
    ...
    @RequestMapping(value = "/jobs/{jobId}/log",
        produces = { "text/plain" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Object> getJobLogById(@ApiParam(value = "Job ID",required=true ) @PathVariable("jobId") String jobId) {
        // do some magic!
